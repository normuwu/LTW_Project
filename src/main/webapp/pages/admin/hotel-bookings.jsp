...
<head>
    ...
    <title>Quản lý Khách sạn Mèo - Admin</title>
...
<body>
    <jsp:include page="/components/admin-sidebar.jsp">
        <jsp:param name="currentPage" value="hotel"/>
    </jsp:include>

    <main class="admin-main">
        <div class="page-header">
            <h1 class="page-title"><i class='bx bxs-hotel'></i> Quản lý Khách sạn Mèo</h1>
        ...
        <div class="table-section">
            <div class="table-header">
                <span class="table-title">
                    <i class='bx bxs-cat'></i> Danh sách đặt phòng khách sạn
                </span>
            </div>
                                ...
                                <tr data-status="${booking.status}">
                                    ...
                                    <td>
                                        <c:if test="${booking.status == 'Pending'}">
                                            <form action="${pageContext.request.contextPath}/admin/hotel-bookings" method="POST" style="display:inline;">
                                        ...
                                        <c:if test="${booking.status == 'Completed' || booking.status == 'Cancelled'}">
                                            <form action="${pageContext.request.contextPath}/admin/hotel-bookings" method="POST" style="display:inline;" 
                                                  onsubmit="return confirm('Bạn có chắc muốn xóa đặt phòng này?');">
