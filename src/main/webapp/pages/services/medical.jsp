...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/assets/css/medical.css">
...
<body>
        ...
        <div class="container">
            ...
            <div class="row g-4">
                <div class="col-md-6 col-lg-4">
                    <div class="med-card">
                        <img src="${pageContext.request.contextPath}/assets/images/medical_pic/med_internal.jpg" alt="Nội khoa">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="med-card">
                        <img src="${pageContext.request.contextPath}/assets/images/medical_pic/med_skin.jpg" alt="Da liễu">
                        <div class="med-card-body">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="med-card">
                        <img src="${pageContext.request.contextPath}/assets/images/medical_pic/med_eyes.jpg" alt="Nhãn khoa">
                        <div class="med-card-body">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="med-card">
                        <img src="${pageContext.request.contextPath}/assets/images/medical_pic/med_infectious.jpg" alt="Truyền nhiễm">
                        <div class="med-card-body">
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="med-card">
                        <img src="${pageContext.request.contextPath}/assets/images/medical_pic/med_test.jpg" alt="Xét nghiệm">
                        <div class="med-card-body">
    ...
    <div class="container text-center my-5">
        ...
        <a href="${pageContext.request.contextPath}/booking" class="btn-main">Đặt Lịch Khám</a>
    </div>
