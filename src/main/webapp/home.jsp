...
<body>
    ...
    <section class="hero-section">
        <video autoplay muted loop playsinline class="back-video">
            <source src="${pageContext.request.contextPath}/video/catvid.mp4" type="video/mp4">
        </video>
    ...
    <section class="features-section">
        <div class="container">
            <div class="text-center mb-5">
                <h2 class="section-title">Sự chăm sóc tốt nhất dành cho thú cưng</h2>
            </div>
            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="feature-item">
                        <div class="img-box">
                            <img src="${pageContext.request.contextPath}/homepage_pic/webpic2.jpg" alt="Bác sĩ">
                        </div>
                ...
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="feature-item">
                        <div class="img-box">
                            <img src="${pageContext.request.contextPath}/homepage_pic/webpic5.jpg" alt="Công nghệ">
                        </div>
                        <h5>Công Nghệ Y Học cao cấp và hiện đại</h5>
                        <p>Chúng tôi đầu tư vào cơ sở vật chất để đưa ra chẩn đoán nhanh chóng và chính xác.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="feature-item">
                        <div class="img-box">
                            <img src="${pageContext.request.contextPath}/homepage_pic/webpic3.jpg" alt="Chuyên gia">
                        </div>
                        <h5>Những chuyên gia bạn có thể trông cậy</h5>
                        <p>Mọi thứ chúng tôi làm đều phù hợp hoặc vượt qua các tiêu chuẩn quốc tế.</p>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-6 mb-4">
                    <div class="feature-item">
                        <div class="img-box">
                            <img src="${pageContext.request.contextPath}/homepage_pic/webpic4.jpg" alt="Khách hàng">
                        </div>
                        <h5>Chăm sóc khách hàng tận tâm</h5>
                        <p>Chúng tôi hỗ trợ bạn bằng cách làm cho trải nghiệm của bạn trở nên thoải mái nhất.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="services-dark-section">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-4 mb-5 mb-lg-0">
                    ...
                    <ul class="service-list">
                        <li class="service-item active" onclick="changeService(0)">Sức khỏe lâm sàng</li>
                        <li class="service-item" onclick="changeService(1)">Phẫu thuật</li>
                        <li class="service-item" onclick="changeService(2)">Trị liệu toàn diện</li>
                        <li class="service-item" onclick="changeService(3)">Vận chuyển thú cưng</li>
                        <li class="service-item" onclick="changeService(4)">Khách sạn mèo</li>
                ...
                <div class="col-lg-8 position-relative">
                    <div class="service-display">
                        <img id="service-img" src="${pageContext.request.contextPath}/homepage_pic/webpic11.jpg" class="img-fluid service-main-img" alt="Service Image">
                        
                        <div class="service-content-overlay">
                            <p id="service-desc">
                                Đội ngũ bác sĩ thú y giàu kinh nghiệm của chúng tôi luôn sẵn sàng chẩn đoán và điều trị mọi vấn đề sức khỏe cho thú cưng của bạn.
                            </p>
                            <a href="#" class="btn btn-service-more">Tìm hiểu thêm <i class='bx bx-right-arrow-alt'></i></a>
                        </div>
                    </div>
        ...
        <img src="https://cdn-icons-png.flaticon.com/512/3048/3048122.png" class="decor-bottom-left" alt="Decor">
    </section>
    ...
    <script>
        ...
        const servicesData = [
            ...
            },
            {
                ...
                desc: "Các liệu pháp vật lý trị liệu và phục hồi chức năng giúp thú cưng nhanh chóng lấy lại sức khỏe sau chấn thương.",
                pos: "center center",
                link: "#"
            },
            {
                img: contextPath + "/homepage_pic/webpic7.jpg",
                desc: "Dịch vụ vận chuyển thú cưng chuyên nghiệp, an toàn, đưa đón tận nơi với xe chuyên dụng.",
                pos: "50% 70%",
                link: "#"
            },
            {
