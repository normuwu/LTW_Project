...
<%-- Header cho trang home - giữ nguyên style transparent --%>
    ...
    <div class="container-fluid px-5"> 
        ...
        <div class="d-flex align-items-center">
            ...
            <c:choose>
                ...
                <c:otherwise>
                    <a href="${pageContext.request.contextPath}/login" class="btn btn-outline-light ms-3" style="color: white; border-color: white;">
