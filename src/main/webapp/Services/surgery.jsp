...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/surgery.css">
...
<body>
    ...
    <section class="intro-section container mt-5 mb-5">
        <div class="row align-items-center">
            <div class="col-lg-6">
                <div class="img-frame">
                    <img src="${pageContext.request.contextPath}/surgery_pic/surgery_intro.jpg" alt="Phòng mổ">
                </div>
            </div>
    ...
    <section class="cta-section text-center">
        <div class="container">
            ...
            <a href="${pageContext.request.contextPath}/services.jsp" class="btn-booking">
