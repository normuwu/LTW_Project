...
<head>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/css/spa.css">
    ...
    <section class="gallery-section container">
        ...
        <div class="gallery-grid">
            <div class="gallery-item tall">
                <img src="${pageContext.request.contextPath}/spa_pic/webpic26.jpg" alt="Grooming 1">
                <div class="overlay"></div>
            </div>

            <div class="gallery-item big">
                <img src="${pageContext.request.contextPath}/spa_pic/webpic27.jpg" alt="Grooming 2">
            </div>

            <div class="gallery-item tall">
                <img src="${pageContext.request.contextPath}/spa_pic/webpic28.jpg" alt="Grooming 3">
            </div>

            <div class="gallery-item wide">
                <img src="${pageContext.request.contextPath}/spa_pic/webpic29.jpg" alt="Grooming 4">
            </div>

            <div class="gallery-item big">
                <img src="${pageContext.request.contextPath}/spa_pic/webpic30.jpg" alt="Grooming 5">
            </div>
            
            <div class="gallery-item">
                <img src="${pageContext.request.contextPath}/spa_pic/webpic31.jpg" alt="Grooming 6">
            </div>
            
            <div class="gallery-item">
                <img src="${pageContext.request.contextPath}/spa_pic/webpic32.jpg" alt="Grooming 7">
            </div>
        </div>
