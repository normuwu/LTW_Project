...
<body>
	...
	<section class="hero-section">
		<video autoplay muted loop playsinline class="back-video">
			<source src="${pageContext.request.contextPath}/video/catvid.mp4"
				type="video/mp4">
		</video>
			...
			<div class="row">
				...
				<div class="col-lg-3 col-md-6 mb-4">
					<div class="feature-item">
						<div class="img-box">
							<img
								src="${pageContext.request.contextPath}/homepage_pic/webpic5.jpg"
								alt="Công nghệ">
						</div>
				...
				<div class="col-lg-3 col-md-6 mb-4">
					<div class="feature-item">
						<div class="img-box">
							<img
								src="${pageContext.request.contextPath}/homepage_pic/webpic3.jpg"
								alt="Chuyên gia">
						</div>
				...
				<div class="col-lg-3 col-md-6 mb-4">
					<div class="feature-item">
						<div class="img-box">
							<img
								src="${pageContext.request.contextPath}/homepage_pic/webpic4.jpg"
								alt="Khách hàng">
						</div>
			...
			<div class="row align-items-center">
				...
				<div class="col-lg-8 position-relative">
					<div class="service-display">
						<img id="service-img"
							src="${pageContext.request.contextPath}/homepage_pic/webpic11.jpg"
